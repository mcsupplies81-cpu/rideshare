...
type Props = { label: string; documentType: string; onUploaded: (path: string) => void; validateFile?: (file: File) => boolean; onUploadStatusChange?: (status: 'pending' | 'uploading' | 'uploaded') => void }

export function DocumentUpload({ label, documentType, onUploaded, validateFile, onUploadStatusChange }: Props) {
